...
public class Climber extends SubsystemBase {
  ...
  CANSparkMax shuttleMotor0 = new CANSparkMax(Constants.kShuttleMotor0Id, MotorType.kBrushless);
  CANSparkMax shuttleMotor1 = new CANSparkMax(Constants.kShuttleMotor1Id, MotorType.kBrushless);
